...
public class JedisClientCluster implements JedisClient {
    private Logger logger = LoggerFactory.getLogger(JedisClientCluster.class);
    @Autowired
    ...
    public int getHashSize(String key) {
        int result = 0;
        try {
            result = jedisCluster.hlen(key).intValue();
        } catch (Exception e) {
    ...
    public int getHashObjectSize(String key) {
        int result = 0;
        try {
            result = jedisCluster.hlen(getBytesKey(key)).intValue();
        } catch (Exception e) {
    ...
    public Set<byte[]> getHashObjectKeys(String key) {
        ...
        try {
            result = jedisCluster.hkeys(getBytesKey(key));
        } catch (Exception e) {
    ...
    public Collection<byte[]> getHashObjectValues(String key) {
        ...
        try {
            result = jedisCluster.hvals(getBytesKey(key));
        } catch (Exception e) {
            logger.warn("getHashValues {}", key, e);
        }
        return result;
    ...
    public Object getHashObject(String key, Object field) {
        Object result = null;
        try {
            result = toObject(jedisCluster.hget(getBytesKey(key), getBytesKey(field)));
        } catch (Exception e) {
            logger.warn("getHash {} = {}", key, field, e);
        }
        return result;
    ...
    public long setHashObject(String key, Object field, Object value) {
        long result = 0L;
        try {
            result = jedisCluster.hset(getBytesKey(key), getBytesKey(field), toBytes(value));
        } catch (Exception e) {
            logger.warn("setHash {} : {} = {}", key, field, value, e);
        }
        return result;
	...
	public long setObjectList(String key, List<Object> value, int cacheSeconds) {
		...
		try {
			...
			result = jedisCluster.rpush(getBytesKey(key), list.toArray(new byte[list.size()][]));
			if (cacheSeconds != 0) {
				jedisCluster.expire(key, cacheSeconds);
			}
		} catch (Exception e) {
	...
	public long setSet(String key, Set<String> value, int cacheSeconds) {
		...
		try {
			...
			result = jedisCluster.sadd(key, value.toArray(new String[value.size()]));
			if (cacheSeconds != 0) {
				jedisCluster.expire(key, cacheSeconds);
			}
		} catch (Exception e) {
	...
	public long setObjectSet(String key, Set<Object> value, int cacheSeconds) {
		...
		try {
			...
			result = jedisCluster.sadd(getBytesKey(key), set.toArray(new byte[set.size()][]));
			if (cacheSeconds != 0) {
				jedisCluster.expire(key, cacheSeconds);
			}
		} catch (Exception e) {
	...
	public long setSetObjectAdd(String key, Object... value) {
		...
		try {
			...
			result = jedisCluster.rpush(getBytesKey(key), set.toArray(new byte[set.size()][]));
		} catch (Exception e) {
    ...
    public long mapObjectClear(String key) {
        long result = 0;
        try {
            result = jedisCluster.hdel(getBytesKey(key));
        } catch (Exception e) {
